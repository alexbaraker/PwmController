# Quartus II compile script for DE2-SoC  board

# 1) project name
set project_name "pwm_module"

#create a temporaty file to know the output file name
set fileID [open "project.tmp" "w"]
puts -nonewline $fileID $project_name
close $fileID
...
set_global_assignment -name PROJECT_CREATION_TIME_DATE "JANUARY 26, 2019"
...
# 2) Design Settings
set_global_assignment -name TOP_LEVEL_ENTITY PwmController
set_global_assignment -name PROJECT_OUTPUT_DIRECTORY ../output

# 3) Relative path files
set_global_assignment -name VHDL_FILE ../../src/fpga/PwmController.vhd
